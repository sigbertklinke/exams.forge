...
#' is used, see \code{system.file('template', 'hu_german.Rmd', package="exams.forge")}.
...
#'   file.copy(system.file('json', 'Test-Klausur-Statistik.json', package="exams.forge"), '.')
...
json2report <- function(json, template=NULL, title=NULL, author='', pdf_param=list(), ...) {
  ...
  if (is.null(template)) template <- system.file('template', 'hu_german.Rmd', package="exams.forge") 
  #  
